...
생성 시각: 2026-05-26T12:04:24.015Z
Run: gold-100-rootfix
...
{
  "caseCount": 100,
  "generatedAt": "2026-05-26T12:04:24.013Z",
  "distributions": {
    "categoryCounts": {
  ...
  "ranking": {
    ...
    "changedVsNearestCount": 40,
    "softTimeExceededTop1Count": 4,
    ...
    "medianSoftTimeExceededCandidateCount": 30,
    "medianTop1TimeSoftPenalty": 0,
    "top1BedTierCounts": {
      "low_risk_6_10": 49,
      "stable_buffer_gt_10": 36,
      "medium_risk_3_5": 12,
      "high_risk_1_2": 3
    },
    "lowSlackUnder5MinCount": 18,
    "softFlagCounts": {
      "max_transport_time_soft_exceeded": 4
    },
    ...
    "top1HospitalCounts": {
      ...
      "순천향대학교부속서울병원": 4,
      "한양대학교병원": 11,
      "학교법인고려중앙학원고려대학교의과대학부속병원(안암병원)": 6,
      "의료법인한전의료재단한일병원": 6,
      "건국대학교병원": 5,
      "서울특별시서울의료원": 5,
      "이화여자대학교의과대학부속목동병원": 7,
...
- evidence: 72/100 cases now use medical incident enums, but 7/96 non-trauma high-acuity cases with no source trauma mechanism still mapped to trauma-centered incident enums.
...
- evidence: 0 hard no-feasible cases, 4 no within-time feasible cases, 4 top-1 soft transport exceedances, and 18 top recommendations with 0-5 minutes slack.
...
### 3. 병상 버퍼는 작동하지만 ETA 시점 가용성은 아직 모델링하지 못함
- evidence: 3 top-1 recommendations still had only 1-2 available ER beds.
- root cause: 현재 모델은 현재 시점 병상 수를 쓰며 이송 중 병상 소진 확률을 직접 예측하지 않는다.
- fix direction: NEMC polling history로 arrival-time-adjusted capacity를 추정하고, low-buffer top-1에는 fallback 후보를 함께 노출한다.
- not fix yet: 단순히 1-2개 병상 병원을 전부 금지하면 가까운 적정 병원을 과도하게 배제할 수 있다.
...
|GOLD-002|stroke_neuro_consciousness|중구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|tight_transport_window|
|GOLD-003|cardiac_arrest_rosc|용산구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack|
...
|GOLD-007|stroke_neuro_consciousness|동대문구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
...
|GOLD-015|respiratory_failure_airway|광진구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
|GOLD-016|stroke_neuro_consciousness|강북구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능||
...
|GOLD-019|stroke_neuro_consciousness|은평구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|1순위 추천이 요청 이송시간을 초과해 소프트 페널티로 처리됨|incident_schema_coverage_gap, no_within_time_feasible_candidate, soft_transport_exceeded_top1|
...
|GOLD-022|major_bleeding_gi|종로구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
|GOLD-023|respiratory_failure_airway|은평구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능||
|GOLD-024|stroke_neuro_consciousness|서대문구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
...
|GOLD-028|cardiac_arrest_rosc|노원구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack|
|GOLD-029|major_bleeding_gi|용산구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|low_time_slack|
...
|GOLD-032|cardiac_arrest_rosc|은평구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack, differs_from_nearest_feasible|
|GOLD-033|cardiac_arrest_rosc|마포구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack, differs_from_nearest_feasible|
|GOLD-034|cardiac_arrest_rosc|마포구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|추천 후보는 현재 정식화 기준 납득 가능|incident_schema_coverage_gap, differs_from_nearest_feasible|
...
|GOLD-037|respiratory_failure_airway|양천구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|low_time_slack, differs_from_nearest_feasible|
|GOLD-038|stroke_neuro_consciousness|강서구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
...
|GOLD-042|seizure_neurologic|동대문구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
|GOLD-043|stroke_neuro_consciousness|금천구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|추천 후보는 현재 정식화 기준 납득 가능|incident_schema_coverage_gap, differs_from_nearest_feasible|
|GOLD-044|major_bleeding_gi|광진구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|추천 후보는 현재 정식화 기준 납득 가능|incident_schema_coverage_gap, differs_from_nearest_feasible|
|GOLD-045|major_bleeding_gi|중랑구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능||
|GOLD-046|cardiac_arrest_rosc|양천구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|low_time_slack, differs_from_nearest_feasible|
|GOLD-047|major_trauma_head_injury|용산구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|low_time_slack|
...
|GOLD-054|respiratory_failure_airway|동작구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능||
...
|GOLD-057|cardiac_arrest_rosc|구로구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|추천 후보는 현재 정식화 기준 납득 가능|incident_schema_coverage_gap, differs_from_nearest_feasible|
|GOLD-058|major_trauma_head_injury|광진구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능||
...
|GOLD-062|stroke_neuro_consciousness|동작구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|추천 후보는 현재 정식화 기준 납득 가능|incident_schema_coverage_gap|
|GOLD-063|respiratory_failure_airway|관악구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능||
|GOLD-064|stroke_neuro_consciousness|관악구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|tight_transport_window|
|GOLD-065|stroke_neuro_consciousness|관악구|핵심 증상 보존 후보|비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨|추천 후보는 현재 정식화 기준 납득 가능|incident_schema_coverage_gap|
|GOLD-066|stroke_neuro_consciousness|서초구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천이 1-2개 병상 고위험 버퍼|tight_transport_window, thin_bed_buffer_top1|
|GOLD-067|respiratory_failure_airway|서초구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack, thin_bed_buffer_top1|
...
|GOLD-069|stroke_neuro_consciousness|서초구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|differs_from_nearest_feasible|
...
|GOLD-072|cardiac_arrest_rosc|영등포구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack, differs_from_nearest_feasible|
...
|GOLD-075|respiratory_failure_airway|서초구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천이 1-2개 병상 고위험 버퍼|tight_transport_window, thin_bed_buffer_top1|
...
|GOLD-083|seizure_neurologic|강북구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|tight_transport_window|
|GOLD-084|stroke_neuro_consciousness|송파구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|1순위 추천의 이송시간 여유가 5분 미만|tight_transport_window, low_time_slack, differs_from_nearest_feasible|
...
|GOLD-095|chest_pain_cardiac|광진구|핵심 증상 보존 후보|OR parameter 자동 판정 후보|추천 후보는 현재 정식화 기준 납득 가능|tight_transport_window, differs_from_nearest_feasible|
...
- note: top=강북삼성병원, 9분, 6 beds; max_transport=10분; hard_feasible=44; within_time_feasible=2; top1_time_soft_penalty=0
...
- note: top=국립중앙의료원, 7분, 9 beds; max_transport=15분; hard_feasible=44; within_time_feasible=6; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 1순위 추천의 이송시간 여유가 5분 미만
- note: top=순천향대학교부속서울병원, 9분, 14 beds; max_transport=10분; hard_feasible=44; within_time_feasible=1; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=한양대학교병원, 10분, 14 beds; max_transport=20분; hard_feasible=42; within_time_feasible=9; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=학교법인고려중앙학원고려대학교의과대학부속병원(안암병원), 7분, 9 beds; max_transport=15분; hard_feasible=43; within_time_feasible=5; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=한양대학교병원, 7분, 14 beds; max_transport=15분; hard_feasible=43; within_time_feasible=5; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=국립중앙의료원, 7분, 9 beds; max_transport=15분; hard_feasible=42; within_time_feasible=6; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=건국대학교병원, 6분, 13 beds; max_transport=20분; hard_feasible=43; within_time_feasible=7; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=서울특별시서울의료원, 6분, 8 beds; max_transport=15분; hard_feasible=43; within_time_feasible=6; top1_time_soft_penalty=0
...
- note: top=서울특별시서울의료원, 22분, 8 beds; max_transport=20분; hard_feasible=13; within_time_feasible=0; top1_time_soft_penalty=664

### GOLD-019 · stroke_neuro_consciousness · 은평구
- tags: incident_schema_coverage_gap, no_within_time_feasible_candidate, soft_transport_exceeded_top1
- stage1: 핵심 증상 보존 후보
- stage2: 비외상 고위험 케이스가 외상 중심 incident enum에 강제 매핑됨
- ranking: 1순위 추천이 요청 이송시간을 초과해 소프트 페널티로 처리됨
- note: top=이화여자대학교의과대학부속목동병원, 27분, 5 beds; max_transport=20분; hard_feasible=6; within_time_feasible=0; top1_time_soft_penalty=1534
...
- stage2: OR parameter 자동 판정 후보
- ranking: 1순위 추천의 이송시간 여유가 5분 미만
- note: top=의료법인한전의료재단한일병원, 13분, 9 beds; max_transport=15분; hard_feasible=43; within_time_feasible=2; top1_time_soft_penalty=0

### GOLD-022 · major_bleeding_gi · 종로구
- tags: differs_from_nearest_feasible
- stage1: 핵심 증상 보존 후보
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=학교법인고려중앙학원고려대학교의과대학부속병원(안암병원), 18분, 9 beds; max_transport=30분; hard_feasible=13; within_time_feasible=7; top1_time_soft_penalty=0
...
- stage2: OR parameter 자동 판정 후보
- ranking: 추천 후보는 현재 정식화 기준 납득 가능
- note: top=강북삼성병원, 13분, 6 beds; max_transport=20분; hard_feasible=13; within_time_feasible=3; top1_time_soft_penalty=0
